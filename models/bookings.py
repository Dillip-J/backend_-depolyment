...
from sqlalchemy import Column, String, BigInteger, Text, ForeignKey, DateTime, Integer, Numeric
...
class Booking(Base):
    ...
    building_name = Column(String(255), nullable=False, server_default="Online")
    landmark = Column(String(255), nullable=False, server_default="Online")
...
# import string
# from sqlalchemy.dialects.postgresql import UUID
# from sqlalchemy import Column, String, BigInteger, Text, ForeignKey, DateTime, Integer
# from sqlalchemy.orm import relationship
# from database import Base
# from datetime import datetime
