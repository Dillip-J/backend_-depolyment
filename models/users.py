...
class User(Base):
    ...
    profile_photo_url = Column(String(500), nullable=True) # 🚨 ADDED to match SQL
    created_at = Column(DateTime, default=datetime.utcnow)
    
    bookings = relationship("Booking", back_populates="user", cascade="all, delete-orphan")
    
    # 🚨 COMMENTED OUT: saved_addresses relation
...
# 🚨 COMMENTED OUT: SavedAddress 
# (This was dropped in Phase 1 of your SQL script and never rebuilt)
'''
...
# import uuid
# from sqlalchemy.dialects.postgresql import UUID
# from sqlalchemy import Column, String, BigInteger, Text, Numeric, DateTime
# from sqlalchemy.orm import relationship
# from database import Base
# from datetime import datetime
